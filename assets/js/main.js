...
const sendEmail = (e) => {
    ...
    if(contactName.value === '' || contactEmail.value === '' || contactFeedback.value === ''){
        contactMessage.classList.remove('color-blue')
        contactMessage.classList.add('color-red')

        contactMessage.textContent = 'Enter the input fields 📧'
    }else{
        emailjs.sendForm('service_1gxua2e','template_otko0ir','#contact-form','eRZ5LXvvA66VHsnCF')
        .then(() => {
